...
from cloudshell.networking.brocade.fastiron.runners.fastiron_connectivity_runner import \
...
class BrocadeFastIronShellDriver(ResourceDriverInterface, NetworkingResourceDriverInterface, GlobalLock):
    SUPPORTED_OS = [r"Brocade.+ICX.+IronWare"]
    SHELL_NAME = "Brocade FastIron Switch 2G"
    # SHELL_NAME = ""

    def __init__(self):
        super(BrocadeFastIronShellDriver, self).__init__()
        self._cli = None
